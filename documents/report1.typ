...
#figure(
  table(
      ...
      [8$k Omega$], [1.95V], [9$k Omega$], [1.96V],
      [10$k Omega$], [1.96V],
  ),
  caption: [@311 实验数据]
)<biao1>
...
=== 实验分析
#set par(hanging-indent: 0em, first-line-indent: 2em)
分析结果,*在一定的工作范围内*,基本和@equation2 和@equation3 所示规律一致。当预期放大电压大于集成运放的输入($12V$)时,增速明显放缓,无法越过这个值。

= 实验总结


通过本次实验，我对电路的基本特性及运放的工作原理有了更深入的理解，也在实践操作中提升了动手能力和问题分析能力。此次实验让我深刻认识到理论与实践相结合的重要性。课本上的公式和原理只有在亲手操作中才能真正理解其内涵，实验中观察到的现象也进一步巩固了理论知识。
